...
func NewStaticWorkerPool(priorityWorker uint32, normalWorker uint32, readGlobalMaxBlocks int64) (*staticWorkerPool, error) {
	...
	fmt.Printf("staticWorkerPool: creating with %d normal, and %d priority workers.\n", normalWorker, priorityWorker)
...
func (swp *staticWorkerPool) Stop() {
	...
	fmt.Printf("staticWorkerPool: stopping all the workers.\n")
	close(swp.stop)
